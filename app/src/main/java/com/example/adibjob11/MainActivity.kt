    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn.setOnClickListener {
            AlertDialog.Builder(this)
                ...
                .setMessage("Nama : Adib muzakki" + "Nis : 2233243" + "Kelas : XI PPLG 1")
        ...
        btn1.setOnClickListener {
            ...
            val dialogLayout = inflater.inflate(R.layout.activity_maindialog2, null)
